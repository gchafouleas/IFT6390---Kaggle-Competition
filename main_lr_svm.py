...
save_model('models/logistic_regression_model_10000.pkl', logreg)
...
save_precision('models/logistic_regression_precision_10000.txt', precision_LR, accuracy_LR)
...
save_model('models/svm_model_10000.pkl', SVM)
...
save_precision('models/svm_precision_10000.txt', precision_SVM, accuracy_SVM)
